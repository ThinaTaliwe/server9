...
<html>
    <head>
        ...
        <script id="swagger-data" type="application/json"><?php echo Illuminate\Support\Js::encode($swagger_data); ?></script>
    </head>
    <body>
        <header>
            <a id="logo" href="https://api-platform.com/"><img src="/vendor/api-platform/logo-header.svg" alt="API Platform"></a>
        </header>
        <?php if(config('api-platform.show_webby', true)): ?>
...
<?php /**PATH /app/vendor/api-platform/laravel/resources/views/swagger-ui.blade.php ENDPATH**/ ?>